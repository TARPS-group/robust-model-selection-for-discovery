...
# -*- coding: utf-8 -*-
"""
This file contains utils functions including:
    - Timer: to time the algorithm
    - create_folder_if_not_exist: create a directory if not exist
    - check_if_data_exists: check if data exists in the path
"""
